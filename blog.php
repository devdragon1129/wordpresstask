      ...
      <div class="container py-4">
        ...
        <article class="postcard dark blue">
          <a class="postcard__img_link" href="#">
            <img class="postcard__img" src="images/image.jpg" alt="Image Title" />
          </a>
          <div class="postcard__text">
            <h1 class="postcard__title blue"><a href="#">Podcast Title</a></h1>
            <div class="postcard__subtitle small">
              <time datetime="2020-05-25 12:00:00">
                <i class="fas fa-calendar-alt mr-2"></i>Sun, Nov 6th 2022
              </time>
            </div>
            ...
            <ul class="postcard__tagbox">
              <li class="tag__item play blue">
                <a href="#"><i class="fas fa-play mr-2"></i>View Detail</i></a>
              </li>
            </ul>
          </div>
        </article>
      ...
      <div class="container py-2">
        ...
        <article class="postcard light blue">
          ...
          <div class="postcard__text t-dark">
            ...
            <ul class="postcard__tagbox">
              <li class="tag__item play blue">
                <a href="#"><i class="fas fa-play mr-2"></i>View Detail</a>
              </li>
            </ul>
          </div>
        </article>
